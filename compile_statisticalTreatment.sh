...
clang++ -o bin/runStatisticalTreatment build/statisticalTreatmentTH_main.o build/statisticalTreatmentTH.o build/statConfig.o `root-config --glibs`
clang++ -o bin/readStatisticalTreatment build/statisticalTreatmentTH_read.o build/statisticalTreatmentTH.o `root-config --glibs`
clang++ -o bin/geneStatisticalTreatment build/statisticalTreatmentTH_gene.o build/statisticalTreatmentTH.o `root-config --glibs`
