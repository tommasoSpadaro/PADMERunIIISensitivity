...
#clang++ `root-config --cflags` -fPIC -Wall -O3 -g -c statisticalTreatmentTH_vfit.C -o build/statisticalTreatmentTH_vfit.o
...
#clang++ -D VFIT -o bin/runStatisticalTreatmentvfit build/statisticalTreatmentTH_main.o  build/statConfig.o build/statisticalTreatmentTH_vfit.o `root-config --glibs`
