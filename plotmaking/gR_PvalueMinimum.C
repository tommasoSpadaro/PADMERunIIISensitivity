...
#endif
void gR_PvalueMinimum()
{
//=========Macro generated from canvas: rcanva/
//=========  (Tue May 27 18:45:45 2025) by ROOT version 6.30/04
   TCanvas *rcanva = new TCanvas("rcanva", "",516,66,1084,598);
   gStyle->SetOptFit(1);
   gStyle->SetOptTitle(0);
   rcanva->Range(16.07895,0.9634211,17.65789,1.081842);
   ...
   TH1F *hframe__1 = new TH1F("hframe__1","",1000,16.3,17.5);
   hframe__1->SetMinimum(0.98);
   hframe__1->SetMaximum(1.07);
   ...
   hframe__1->GetYaxis()->SetTitle("g_{R}(s)");
   hframe__1->GetYaxis()->SetNdivisions(405);
   ...
   TH1F *Graph_gRSideband_scan01001 = new TH1F("Graph_gRSideband_scan01001","",100,16.28474,17.50358);
   Graph_gRSideband_scan01001->SetMinimum(0.9833775);
   Graph_gRSideband_scan01001->SetMaximum(1.040986);
   Graph_gRSideband_scan01001->SetDirectory(nullptr);
   Graph_gRSideband_scan01001->SetStats(0);
   Graph_gRSideband_scan01001->SetLineWidth(2);
   Graph_gRSideband_scan01001->SetMarkerStyle(20);
   Graph_gRSideband_scan01001->GetXaxis()->SetLabelFont(42);
   Graph_gRSideband_scan01001->GetXaxis()->SetLabelSize(0.06);
   Graph_gRSideband_scan01001->GetXaxis()->SetTitleSize(0.06);
   Graph_gRSideband_scan01001->GetXaxis()->SetTitleOffset(1.1);
   Graph_gRSideband_scan01001->GetYaxis()->SetLabelFont(42);
   Graph_gRSideband_scan01001->GetYaxis()->SetLabelSize(0.06);
   Graph_gRSideband_scan01001->GetYaxis()->SetTitleSize(0.06);
   Graph_gRSideband_scan01001->GetZaxis()->SetLabelFont(42);
   Graph_gRSideband_scan01001->GetZaxis()->SetLabelSize(0.06);
   Graph_gRSideband_scan01001->GetZaxis()->SetTitleSize(0.06);
   Graph_gRSideband_scan01001->GetZaxis()->SetTitleOffset(0.7);
   gre->SetHistogram(Graph_gRSideband_scan01001);
   ...
   TH1F *Graph_gRMasked_scan01002 = new TH1F("Graph_gRMasked_scan01002","",100,16.79508,17.01706);
   Graph_gRMasked_scan01002->SetMinimum(0.9878185);
   Graph_gRMasked_scan01002->SetMaximum(1.041971);
   Graph_gRMasked_scan01002->SetDirectory(nullptr);
   Graph_gRMasked_scan01002->SetStats(0);
   Graph_gRMasked_scan01002->SetLineWidth(2);
   Graph_gRMasked_scan01002->SetMarkerStyle(20);
   Graph_gRMasked_scan01002->GetXaxis()->SetLabelFont(42);
   Graph_gRMasked_scan01002->GetXaxis()->SetLabelSize(0.06);
   Graph_gRMasked_scan01002->GetXaxis()->SetTitleSize(0.06);
   Graph_gRMasked_scan01002->GetXaxis()->SetTitleOffset(1.1);
   Graph_gRMasked_scan01002->GetYaxis()->SetLabelFont(42);
   Graph_gRMasked_scan01002->GetYaxis()->SetLabelSize(0.06);
   Graph_gRMasked_scan01002->GetYaxis()->SetTitleSize(0.06);
   Graph_gRMasked_scan01002->GetZaxis()->SetLabelFont(42);
   Graph_gRMasked_scan01002->GetZaxis()->SetLabelSize(0.06);
   Graph_gRMasked_scan01002->GetZaxis()->SetTitleSize(0.06);
   Graph_gRMasked_scan01002->GetZaxis()->SetTitleOffset(0.7);
   gre->SetHistogram(Graph_gRMasked_scan01002);
   ...
   TH1F *Graph_gRSideband_scan11003 = new TH1F("Graph_gRSideband_scan11003","",100,16.47233,17.46537);
   Graph_gRSideband_scan11003->SetMinimum(0.975637);
   Graph_gRSideband_scan11003->SetMaximum(1.046167);
   Graph_gRSideband_scan11003->SetDirectory(nullptr);
   Graph_gRSideband_scan11003->SetStats(0);
   Graph_gRSideband_scan11003->SetLineWidth(2);
   Graph_gRSideband_scan11003->SetMarkerStyle(20);
   Graph_gRSideband_scan11003->GetXaxis()->SetLabelFont(42);
   Graph_gRSideband_scan11003->GetXaxis()->SetLabelSize(0.06);
   Graph_gRSideband_scan11003->GetXaxis()->SetTitleSize(0.06);
   Graph_gRSideband_scan11003->GetXaxis()->SetTitleOffset(1.1);
   Graph_gRSideband_scan11003->GetYaxis()->SetLabelFont(42);
   Graph_gRSideband_scan11003->GetYaxis()->SetLabelSize(0.06);
   Graph_gRSideband_scan11003->GetYaxis()->SetTitleSize(0.06);
   Graph_gRSideband_scan11003->GetZaxis()->SetLabelFont(42);
   Graph_gRSideband_scan11003->GetZaxis()->SetLabelSize(0.06);
   Graph_gRSideband_scan11003->GetZaxis()->SetTitleSize(0.06);
   Graph_gRSideband_scan11003->GetZaxis()->SetTitleOffset(0.7);
   gre->SetHistogram(Graph_gRSideband_scan11003);
   ...
   TH1F *Graph_gRMasked_scan11004 = new TH1F("Graph_gRMasked_scan11004","",100,16.77563,17.00111);
   Graph_gRMasked_scan11004->SetMinimum(0.9927282);
   Graph_gRMasked_scan11004->SetMaximum(1.045916);
   Graph_gRMasked_scan11004->SetDirectory(nullptr);
   Graph_gRMasked_scan11004->SetStats(0);
   Graph_gRMasked_scan11004->SetLineWidth(2);
   Graph_gRMasked_scan11004->SetMarkerStyle(20);
   Graph_gRMasked_scan11004->GetXaxis()->SetLabelFont(42);
   Graph_gRMasked_scan11004->GetXaxis()->SetLabelSize(0.06);
   Graph_gRMasked_scan11004->GetXaxis()->SetTitleSize(0.06);
   Graph_gRMasked_scan11004->GetXaxis()->SetTitleOffset(1.1);
   Graph_gRMasked_scan11004->GetYaxis()->SetLabelFont(42);
   Graph_gRMasked_scan11004->GetYaxis()->SetLabelSize(0.06);
   Graph_gRMasked_scan11004->GetYaxis()->SetTitleSize(0.06);
   Graph_gRMasked_scan11004->GetZaxis()->SetLabelFont(42);
   Graph_gRMasked_scan11004->GetZaxis()->SetLabelSize(0.06);
   Graph_gRMasked_scan11004->GetZaxis()->SetTitleSize(0.06);
   Graph_gRMasked_scan11004->GetZaxis()->SetTitleOffset(0.7);
   gre->SetHistogram(Graph_gRMasked_scan11004);
   
   gre->Draw("p");
   
   Double_t SBFitOnBToyGraph_im34_ig20_mass1690_gven000550_pseudoEvts_fx1[42] = {
     16.38631, 16.43395, 16.48146, 16.52852, 16.55508, 16.57698, 16.60224, 16.62377,
     16.65049, 16.67104, 16.698, 16.71757, 16.74658, 16.76397, 16.79442, 16.81358,
     16.84394, 16.85911, 16.88848, 16.90572, 16.93562, 16.9516, 16.98232, 16.99856,
     17.0289, 17.06696, 17.07475, 17.09748, 17.12077, 17.12853, 17.16429, 17.17917,
     17.20592, 17.22433, 17.25071, 17.26818, 17.29449, 17.31664, 17.3367, 17.35996,
     17.38262, 17.40201 };
   ...
   TH1F *Graph_SBFitOnBToyGraph_im34_ig20_mass16dO900000_gven0dO000550_pseudoEvts1 = new TH1F("Graph_SBFitOnBToyGraph_im34_ig20_mass16dO900000_gven0dO000550_pseudoEvts1","",100,16.28474,17.50358);
   Graph_SBFitOnBToyGraph_im34_ig20_mass16dO900000_gven0dO000550_pseudoEvts1->SetMinimum(1.003849);
   Graph_SBFitOnBToyGraph_im34_ig20_mass16dO900000_gven0dO000550_pseudoEvts1->SetMaximum(1.029762);
   Graph_SBFitOnBToyGraph_im34_ig20_mass16dO900000_gven0dO000550_pseudoEvts1->SetDirectory(nullptr);
   Graph_SBFitOnBToyGraph_im34_ig20_mass16dO900000_gven0dO000550_pseudoEvts1->SetStats(0);
   Graph_SBFitOnBToyGraph_im34_ig20_mass16dO900000_gven0dO000550_pseudoEvts1->SetLineWidth(2);
   Graph_SBFitOnBToyGraph_im34_ig20_mass16dO900000_gven0dO000550_pseudoEvts1->SetMarkerStyle(20);
   Graph_SBFitOnBToyGraph_im34_ig20_mass16dO900000_gven0dO000550_pseudoEvts1->GetXaxis()->SetLabelFont(42);
   Graph_SBFitOnBToyGraph_im34_ig20_mass16dO900000_gven0dO000550_pseudoEvts1->GetXaxis()->SetLabelSize(0.06);
   Graph_SBFitOnBToyGraph_im34_ig20_mass16dO900000_gven0dO000550_pseudoEvts1->GetXaxis()->SetTitleSize(0.06);
   Graph_SBFitOnBToyGraph_im34_ig20_mass16dO900000_gven0dO000550_pseudoEvts1->GetXaxis()->SetTitleOffset(1.1);
   Graph_SBFitOnBToyGraph_im34_ig20_mass16dO900000_gven0dO000550_pseudoEvts1->GetYaxis()->SetLabelFont(42);
   Graph_SBFitOnBToyGraph_im34_ig20_mass16dO900000_gven0dO000550_pseudoEvts1->GetYaxis()->SetLabelSize(0.06);
   Graph_SBFitOnBToyGraph_im34_ig20_mass16dO900000_gven0dO000550_pseudoEvts1->GetYaxis()->SetTitleSize(0.06);
   Graph_SBFitOnBToyGraph_im34_ig20_mass16dO900000_gven0dO000550_pseudoEvts1->GetZaxis()->SetLabelFont(42);
